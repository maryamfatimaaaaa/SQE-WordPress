...
SCREENSHOT_DIR = Path("api-tests/screenshots/users-application-passwords_outputs")
...
def test_get_all_users_application_passwords():
    """Test Case 1: Retrieve all users/(?P<user_id>(?:[\\d]+|me))/application-passwords"""
    url = f"{BASE_URL}/wp/v2/users/(?P<user_id>(?:[\\d]+|me))/application-passwords"
    try:
    ...
    save_response_screenshot("get_all_users_application_passwords", response)
...
def test_unauthorized_users_application_passwords():
    """Test Case 2: Unauthorized access to users/(?P<user_id>(?:[\\d]+|me))/application-passwords"""
    url = f"{BASE_URL}/wp/v2/users/(?P<user_id>(?:[\\d]+|me))/application-passwords"
    try:
    ...
    save_response_screenshot("unauthorized_users_application_passwords", response)
...
def test_pagination_users_application_passwords():
    """Test Case 3: Pagination for users/(?P<user_id>(?:[\\d]+|me))/application-passwords"""
    url = f"{BASE_URL}/wp/v2/users/(?P<user_id>(?:[\\d]+|me))/application-passwords?page=1&per_page=5"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
        pytest.skip("WordPress server is not running or not accessible")
    ...
    save_response_screenshot("pagination_users_application_passwords", response)
...
def test_response_schema_users_application_passwords():
    """Test Case 4: Response Schema Validation for users/(?P<user_id>(?:[\\d]+|me))/application-passwords"""
    url = f"{BASE_URL}/wp/v2/users/(?P<user_id>(?:[\\d]+|me))/application-passwords"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("schema_users_application_passwords", response)
...
def test_response_content_type_users_application_passwords():
    """Test Case 5: Response Content Type for users/(?P<user_id>(?:[\\d]+|me))/application-passwords"""
    url = f"{BASE_URL}/wp/v2/users/(?P<user_id>(?:[\\d]+|me))/application-passwords"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("content_type_users_application_passwords", response)
...
def test_response_structure_users_application_passwords():
    """Test Case 6: Response Structure Validation for users/(?P<user_id>(?:[\\d]+|me))/application-passwords"""
    url = f"{BASE_URL}/wp/v2/users/(?P<user_id>(?:[\\d]+|me))/application-passwords"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("structure_users_application_passwords", response)
...
def test_head_users_application_passwords():
    """Test Case 7: HEAD request for users/(?P<user_id>(?:[\\d]+|me))/application-passwords"""
    url = f"{BASE_URL}/wp/v2/users/(?P<user_id>(?:[\\d]+|me))/application-passwords"
    try:
    ...
    save_response_screenshot("head_users_application_passwords", response)
