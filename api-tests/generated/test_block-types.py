...
SCREENSHOT_DIR = Path("api-tests/screenshots/block-types_outputs")
...
def test_get_all_block_types():
    """Test Case 1: Retrieve all block-types"""
    url = f"{BASE_URL}/wp/v2/block-types"
    try:
    ...
    save_response_screenshot("get_all_block_types", response)
...
def test_unauthorized_block_types():
    """Test Case 2: Unauthorized access to block-types"""
    url = f"{BASE_URL}/wp/v2/block-types"
    try:
    ...
    save_response_screenshot("unauthorized_block_types", response)
...
def test_pagination_block_types():
    """Test Case 3: Pagination for block-types"""
    url = f"{BASE_URL}/wp/v2/block-types?page=1&per_page=5"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
        pytest.skip("WordPress server is not running or not accessible")
    ...
    save_response_screenshot("pagination_block_types", response)
...
def test_response_schema_block_types():
    """Test Case 4: Response Schema Validation for block-types"""
    url = f"{BASE_URL}/wp/v2/block-types"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("schema_block_types", response)
...
def test_response_content_type_block_types():
    """Test Case 5: Response Content Type for block-types"""
    url = f"{BASE_URL}/wp/v2/block-types"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("content_type_block_types", response)
...
def test_response_structure_block_types():
    """Test Case 6: Response Structure Validation for block-types"""
    url = f"{BASE_URL}/wp/v2/block-types"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("structure_block_types", response)
...
def test_head_block_types():
    """Test Case 7: HEAD request for block-types"""
    url = f"{BASE_URL}/wp/v2/block-types"
    try:
    ...
    save_response_screenshot("head_block_types", response)
