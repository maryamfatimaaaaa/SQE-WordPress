...
SCREENSHOT_DIR = Path("api-tests/screenshots/font-faces_outputs")
...
def test_get_all_font_faces():
    """Test Case 1: Retrieve all font-faces"""
    url = f"{BASE_URL}/wp/v2/font-faces"
    try:
    ...
    save_response_screenshot("get_all_font_faces", response)
...
def test_unauthorized_font_faces():
    """Test Case 2: Unauthorized access to font-faces"""
    url = f"{BASE_URL}/wp/v2/font-faces"
    try:
    ...
    save_response_screenshot("unauthorized_font_faces", response)
...
def test_pagination_font_faces():
    """Test Case 3: Pagination for font-faces"""
    url = f"{BASE_URL}/wp/v2/font-faces?page=1&per_page=5"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
        pytest.skip("WordPress server is not running or not accessible")
    ...
    save_response_screenshot("pagination_font_faces", response)
...
def test_response_schema_font_faces():
    """Test Case 4: Response Schema Validation for font-faces"""
    url = f"{BASE_URL}/wp/v2/font-faces"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("schema_font_faces", response)
...
def test_response_content_type_font_faces():
    """Test Case 5: Response Content Type for font-faces"""
    url = f"{BASE_URL}/wp/v2/font-faces"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("content_type_font_faces", response)
...
def test_response_structure_font_faces():
    """Test Case 6: Response Structure Validation for font-faces"""
    url = f"{BASE_URL}/wp/v2/font-faces"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("structure_font_faces", response)
...
def test_head_font_faces():
    """Test Case 7: HEAD request for font-faces"""
    url = f"{BASE_URL}/wp/v2/font-faces"
    try:
    ...
    save_response_screenshot("head_font_faces", response)
