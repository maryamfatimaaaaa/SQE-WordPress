...
SCREENSHOT_DIR = Path("api-tests/screenshots/block-patterns-patterns_outputs")
...
def test_get_all_block_patterns_patterns():
    """Test Case 1: Retrieve all block-patterns/patterns"""
    url = f"{BASE_URL}/wp/v2/block-patterns/patterns"
    try:
    ...
    save_response_screenshot("get_all_block_patterns_patterns", response)
...
def test_unauthorized_block_patterns_patterns():
    """Test Case 2: Unauthorized access to block-patterns/patterns"""
    url = f"{BASE_URL}/wp/v2/block-patterns/patterns"
    try:
    ...
    save_response_screenshot("unauthorized_block_patterns_patterns", response)
...
def test_pagination_block_patterns_patterns():
    """Test Case 3: Pagination for block-patterns/patterns"""
    url = f"{BASE_URL}/wp/v2/block-patterns/patterns?page=1&per_page=5"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
        pytest.skip("WordPress server is not running or not accessible")
    ...
    save_response_screenshot("pagination_block_patterns_patterns", response)
...
def test_response_schema_block_patterns_patterns():
    """Test Case 4: Response Schema Validation for block-patterns/patterns"""
    url = f"{BASE_URL}/wp/v2/block-patterns/patterns"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("schema_block_patterns_patterns", response)
...
def test_response_content_type_block_patterns_patterns():
    """Test Case 5: Response Content Type for block-patterns/patterns"""
    url = f"{BASE_URL}/wp/v2/block-patterns/patterns"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("content_type_block_patterns_patterns", response)
...
def test_response_structure_block_patterns_patterns():
    """Test Case 6: Response Structure Validation for block-patterns/patterns"""
    url = f"{BASE_URL}/wp/v2/block-patterns/patterns"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("structure_block_patterns_patterns", response)
...
def test_head_block_patterns_patterns():
    """Test Case 7: HEAD request for block-patterns/patterns"""
    url = f"{BASE_URL}/wp/v2/block-patterns/patterns"
    try:
    ...
    save_response_screenshot("head_block_patterns_patterns", response)
