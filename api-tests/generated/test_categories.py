...
SCREENSHOT_DIR = Path("api-tests/screenshots/categories_outputs")
...
def test_get_all_categories():
    """Test Case 1: Retrieve all categories"""
...
def test_unauthorized_categories():
    """Test Case 2: Unauthorized access to categories"""
    url = f"{BASE_URL}/wp-abilities/v1/categories"
    try:
    ...
    save_response_screenshot("unauthorized_categories", response)
...
def test_pagination_categories():
    """Test Case 3: Pagination for categories"""
    url = f"{BASE_URL}/wp-abilities/v1/categories?page=1&per_page=5"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
        pytest.skip("WordPress server is not running or not accessible")
    ...
    save_response_screenshot("pagination_categories", response)
...
def test_response_schema_categories():
    """Test Case 4: Response Schema Validation for categories"""
    url = f"{BASE_URL}/wp-abilities/v1/categories"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("schema_categories", response)
...
def test_response_content_type_categories():
    """Test Case 5: Response Content Type for categories"""
    url = f"{BASE_URL}/wp-abilities/v1/categories"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("content_type_categories", response)
...
def test_response_structure_categories():
    """Test Case 6: Response Structure Validation for categories"""
    url = f"{BASE_URL}/wp-abilities/v1/categories"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("structure_categories", response)
...
def test_head_categories():
    """Test Case 7: HEAD request for categories"""
    url = f"{BASE_URL}/wp-abilities/v1/categories"
    try:
    ...
    save_response_screenshot("head_categories", response)
