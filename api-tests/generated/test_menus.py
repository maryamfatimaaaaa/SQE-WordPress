...
SCREENSHOT_DIR = Path("api-tests/screenshots/menus_outputs")
...
def test_get_all_menus():
    """Test Case 1: Retrieve all menus"""
    ...
    save_response_screenshot("get_all_menus", response)
...
def test_unauthorized_menus():
    """Test Case 2: Unauthorized access to menus"""
    url = f"{BASE_URL}/wp/v2/menus"
    try:
    ...
    save_response_screenshot("unauthorized_menus", response)
...
def test_pagination_menus():
    """Test Case 3: Pagination for menus"""
    url = f"{BASE_URL}/wp/v2/menus?page=1&per_page=5"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
        pytest.skip("WordPress server is not running or not accessible")
    ...
    save_response_screenshot("pagination_menus", response)
...
def test_response_schema_menus():
    """Test Case 4: Response Schema Validation for menus"""
    url = f"{BASE_URL}/wp/v2/menus"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("schema_menus", response)
...
def test_response_content_type_menus():
    """Test Case 5: Response Content Type for menus"""
    url = f"{BASE_URL}/wp/v2/menus"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("content_type_menus", response)
...
def test_response_structure_menus():
    """Test Case 6: Response Structure Validation for menus"""
    url = f"{BASE_URL}/wp/v2/menus"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("structure_menus", response)
...
def test_head_menus():
    """Test Case 7: HEAD request for menus"""
    url = f"{BASE_URL}/wp/v2/menus"
    try:
    ...
    save_response_screenshot("head_menus", response)
