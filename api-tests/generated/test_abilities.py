...
SCREENSHOT_DIR = Path("api-tests/screenshots/abilities_outputs")
...
def test_get_all_abilities():
    """Test Case 1: Retrieve all abilities"""
...
def test_unauthorized_abilities():
    """Test Case 2: Unauthorized access to abilities"""
    url = f"{BASE_URL}/wp-abilities/v1/abilities"
    try:
    ...
    save_response_screenshot("unauthorized_abilities", response)
...
def test_pagination_abilities():
    """Test Case 3: Pagination for abilities"""
...
def test_response_schema_abilities():
    """Test Case 4: Response Schema Validation for abilities"""
    url = f"{BASE_URL}/wp-abilities/v1/abilities"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("schema_abilities", response)
...
def test_response_content_type_abilities():
    """Test Case 5: Response Content Type for abilities"""
    url = f"{BASE_URL}/wp-abilities/v1/abilities"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("content_type_abilities", response)
...
def test_response_structure_abilities():
    """Test Case 6: Response Structure Validation for abilities"""
    url = f"{BASE_URL}/wp-abilities/v1/abilities"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("structure_abilities", response)
...
def test_head_abilities():
    """Test Case 7: HEAD request for abilities"""
    url = f"{BASE_URL}/wp-abilities/v1/abilities"
    try:
    ...
    save_response_screenshot("head_abilities", response)
