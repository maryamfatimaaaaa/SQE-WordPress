...
SCREENSHOT_DIR = Path("api-tests/screenshots/widget-types_outputs")
...
def test_get_all_widget_types():
    """Test Case 1: Retrieve all widget-types"""
    url = f"{BASE_URL}/wp/v2/widget-types"
    try:
    ...
    save_response_screenshot("get_all_widget_types", response)
...
def test_unauthorized_widget_types():
    """Test Case 2: Unauthorized access to widget-types"""
    url = f"{BASE_URL}/wp/v2/widget-types"
    try:
    ...
    save_response_screenshot("unauthorized_widget_types", response)
...
def test_pagination_widget_types():
    """Test Case 3: Pagination for widget-types"""
    url = f"{BASE_URL}/wp/v2/widget-types?page=1&per_page=5"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
        pytest.skip("WordPress server is not running or not accessible")
    ...
    save_response_screenshot("pagination_widget_types", response)
...
def test_response_schema_widget_types():
    """Test Case 4: Response Schema Validation for widget-types"""
    url = f"{BASE_URL}/wp/v2/widget-types"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("schema_widget_types", response)
...
def test_response_content_type_widget_types():
    """Test Case 5: Response Content Type for widget-types"""
    url = f"{BASE_URL}/wp/v2/widget-types"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("content_type_widget_types", response)
...
def test_response_structure_widget_types():
    """Test Case 6: Response Structure Validation for widget-types"""
    url = f"{BASE_URL}/wp/v2/widget-types"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("structure_widget_types", response)
...
def test_head_widget_types():
    """Test Case 7: HEAD request for widget-types"""
    url = f"{BASE_URL}/wp/v2/widget-types"
    try:
    ...
    save_response_screenshot("head_widget_types", response)
