...
SCREENSHOT_DIR = Path("api-tests/screenshots/menu-locations_outputs")
...
def test_get_all_menu_locations():
    """Test Case 1: Retrieve all menu-locations"""
    url = f"{BASE_URL}/wp/v2/menu-locations"
    try:
    ...
    save_response_screenshot("get_all_menu_locations", response)
...
def test_unauthorized_menu_locations():
    """Test Case 2: Unauthorized access to menu-locations"""
    url = f"{BASE_URL}/wp/v2/menu-locations"
    try:
    ...
    save_response_screenshot("unauthorized_menu_locations", response)
...
def test_pagination_menu_locations():
    """Test Case 3: Pagination for menu-locations"""
    url = f"{BASE_URL}/wp/v2/menu-locations?page=1&per_page=5"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
        pytest.skip("WordPress server is not running or not accessible")
    ...
    save_response_screenshot("pagination_menu_locations", response)
...
def test_response_schema_menu_locations():
    """Test Case 4: Response Schema Validation for menu-locations"""
    url = f"{BASE_URL}/wp/v2/menu-locations"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("schema_menu_locations", response)
...
def test_response_content_type_menu_locations():
    """Test Case 5: Response Content Type for menu-locations"""
    url = f"{BASE_URL}/wp/v2/menu-locations"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("content_type_menu_locations", response)
...
def test_response_structure_menu_locations():
    """Test Case 6: Response Structure Validation for menu-locations"""
    url = f"{BASE_URL}/wp/v2/menu-locations"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("structure_menu_locations", response)
...
def test_head_menu_locations():
    """Test Case 7: HEAD request for menu-locations"""
    url = f"{BASE_URL}/wp/v2/menu-locations"
    try:
    ...
    save_response_screenshot("head_menu_locations", response)
