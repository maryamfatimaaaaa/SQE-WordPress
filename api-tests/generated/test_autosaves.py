...
SCREENSHOT_DIR = Path("api-tests/screenshots/autosaves_outputs")
...
def test_get_all_autosaves():
    """Test Case 1: Retrieve all autosaves"""
    url = f"{BASE_URL}/wp/v2/autosaves"
    try:
    ...
    save_response_screenshot("get_all_autosaves", response)
...
def test_unauthorized_autosaves():
    """Test Case 2: Unauthorized access to autosaves"""
    url = f"{BASE_URL}/wp/v2/autosaves"
    try:
    ...
    save_response_screenshot("unauthorized_autosaves", response)
...
def test_pagination_autosaves():
    """Test Case 3: Pagination for autosaves"""
    url = f"{BASE_URL}/wp/v2/autosaves?page=1&per_page=5"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
        pytest.skip("WordPress server is not running or not accessible")
    ...
    save_response_screenshot("pagination_autosaves", response)
...
def test_response_schema_autosaves():
    """Test Case 4: Response Schema Validation for autosaves"""
    url = f"{BASE_URL}/wp/v2/autosaves"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("schema_autosaves", response)
...
def test_response_content_type_autosaves():
    """Test Case 5: Response Content Type for autosaves"""
    url = f"{BASE_URL}/wp/v2/autosaves"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("content_type_autosaves", response)
...
def test_response_structure_autosaves():
    """Test Case 6: Response Structure Validation for autosaves"""
    url = f"{BASE_URL}/wp/v2/autosaves"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("structure_autosaves", response)
...
def test_head_autosaves():
    """Test Case 7: HEAD request for autosaves"""
    url = f"{BASE_URL}/wp/v2/autosaves"
    try:
    ...
    save_response_screenshot("head_autosaves", response)
