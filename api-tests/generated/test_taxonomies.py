...
SCREENSHOT_DIR = Path("api-tests/screenshots/taxonomies_outputs")
...
def test_get_all_taxonomies():
    """Test Case 1: Retrieve all taxonomies"""
    url = f"{BASE_URL}/wp/v2/taxonomies"
    try:
    ...
    save_response_screenshot("get_all_taxonomies", response)
...
def test_unauthorized_taxonomies():
    """Test Case 2: Unauthorized access to taxonomies"""
    url = f"{BASE_URL}/wp/v2/taxonomies"
    try:
    ...
    save_response_screenshot("unauthorized_taxonomies", response)
...
def test_pagination_taxonomies():
    """Test Case 3: Pagination for taxonomies"""
    url = f"{BASE_URL}/wp/v2/taxonomies?page=1&per_page=5"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
        pytest.skip("WordPress server is not running or not accessible")
    ...
    save_response_screenshot("pagination_taxonomies", response)
...
def test_response_schema_taxonomies():
    """Test Case 4: Response Schema Validation for taxonomies"""
    url = f"{BASE_URL}/wp/v2/taxonomies"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("schema_taxonomies", response)
...
def test_response_content_type_taxonomies():
    """Test Case 5: Response Content Type for taxonomies"""
    url = f"{BASE_URL}/wp/v2/taxonomies"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("content_type_taxonomies", response)
...
def test_response_structure_taxonomies():
    """Test Case 6: Response Structure Validation for taxonomies"""
    url = f"{BASE_URL}/wp/v2/taxonomies"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("structure_taxonomies", response)
...
def test_head_taxonomies():
    """Test Case 7: HEAD request for taxonomies"""
    url = f"{BASE_URL}/wp/v2/taxonomies"
    try:
    ...
    save_response_screenshot("head_taxonomies", response)
