...
SCREENSHOT_DIR = Path("api-tests/screenshots/export_outputs")
...
def test_get_all_export():
    """Test Case 1: Retrieve all export"""
    url = f"{BASE_URL}/wp-block-editor/v1/export"
    try:
    ...
    save_response_screenshot("get_all_export", response)
...
def test_unauthorized_export():
    """Test Case 2: Unauthorized access to export"""
    url = f"{BASE_URL}/wp-block-editor/v1/export"
    try:
    ...
    save_response_screenshot("unauthorized_export", response)
...
def test_pagination_export():
    """Test Case 3: Pagination for export"""
    url = f"{BASE_URL}/wp-block-editor/v1/export?page=1&per_page=5"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
        pytest.skip("WordPress server is not running or not accessible")
    ...
    save_response_screenshot("pagination_export", response)
...
def test_response_schema_export():
    """Test Case 4: Response Schema Validation for export"""
    url = f"{BASE_URL}/wp-block-editor/v1/export"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("schema_export", response)
...
def test_response_content_type_export():
    """Test Case 5: Response Content Type for export"""
    url = f"{BASE_URL}/wp-block-editor/v1/export"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("content_type_export", response)
...
def test_response_structure_export():
    """Test Case 6: Response Structure Validation for export"""
    url = f"{BASE_URL}/wp-block-editor/v1/export"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("structure_export", response)
