...
SCREENSHOT_DIR = Path("api-tests/screenshots/font-collections_outputs")
...
def test_get_all_font_collections():
    """Test Case 1: Retrieve all font-collections"""
    url = f"{BASE_URL}/wp/v2/font-collections"
    try:
    ...
    save_response_screenshot("get_all_font_collections", response)
...
def test_unauthorized_font_collections():
    """Test Case 2: Unauthorized access to font-collections"""
    url = f"{BASE_URL}/wp/v2/font-collections"
    try:
    ...
    save_response_screenshot("unauthorized_font_collections", response)
...
def test_pagination_font_collections():
    """Test Case 3: Pagination for font-collections"""
    url = f"{BASE_URL}/wp/v2/font-collections?page=1&per_page=5"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
        pytest.skip("WordPress server is not running or not accessible")
    ...
    save_response_screenshot("pagination_font_collections", response)
...
def test_response_schema_font_collections():
    """Test Case 4: Response Schema Validation for font-collections"""
    url = f"{BASE_URL}/wp/v2/font-collections"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("schema_font_collections", response)
...
def test_response_content_type_font_collections():
    """Test Case 5: Response Content Type for font-collections"""
    url = f"{BASE_URL}/wp/v2/font-collections"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("content_type_font_collections", response)
...
def test_response_structure_font_collections():
    """Test Case 6: Response Structure Validation for font-collections"""
    url = f"{BASE_URL}/wp/v2/font-collections"
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
    ...
    save_response_screenshot("structure_font_collections", response)
...
def test_head_font_collections():
    """Test Case 7: HEAD request for font-collections"""
    url = f"{BASE_URL}/wp/v2/font-collections"
    try:
    ...
    save_response_screenshot("head_font_collections", response)
