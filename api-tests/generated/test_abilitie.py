...
SCREENSHOT_DIR = Path("api-tests/screenshots/abilitie_outputs")
...
def test_get_valid_abilitie():
    """Test Case 1: Get valid abilitie"""
    ...
    url = f"{BASE_URL}/wp-abilities/v1/abilities/{{id}}".replace("{{id}}", str(identifier))
    try:
    ...
    save_response_screenshot("get_valid_abilitie", response)
...
def test_get_invalid_abilitie():
    """Test Case 2: Get invalid abilitie"""
    url = f"{BASE_URL}/wp-abilities/v1/abilities/{{id}}".replace("{{id}}", "invalid-999999")
    try:
        response = requests.get(url, auth=HTTPBasicAuth(USERNAME, APP_PASSWORD), timeout=10)
    except requests.exceptions.ConnectionError:
        pytest.skip("WordPress server is not running or not accessible")
    ...
    save_response_screenshot("get_invalid_abilitie", response)
    
    # Accept 404 (not found) as expected, or 200 if somehow valid
    assert response.status_code in [200, 404], f"Expected 200 or 404, got {response.status_code}"

def test_unauthorized_abilitie():
    """Test Case 3: Unauthorized access to abilitie"""
    url = f"{BASE_URL}/wp-abilities/v1/abilities/{{id}}".replace("{{id}}", "test")
    try:
    ...
    save_response_screenshot("unauthorized_abilitie", response)
...
def test_response_schema_abilitie():
    """Test Case 4: Response Schema Validation for abilitie"""
    # First, get list to find a valid identifier
    list_path = "/wp-abilities/v1/abilities"
    list_url = f"{BASE_URL}{list_path}"
    try:
    ...
    save_response_screenshot("schema_abilitie", response)
...
def test_response_content_type_abilitie():
    """Test Case 5: Response Content Type for abilitie"""
    # First, get list to find a valid identifier
    list_path = "/wp-abilities/v1/abilities"
    list_url = f"{BASE_URL}{list_path}"
    try:
    ...
    save_response_screenshot("content_type_abilitie", response)
...
def test_response_structure_abilitie():
    """Test Case 6: Response Structure Validation for abilitie"""
    # First, get list to find a valid identifier
    list_path = "/wp-abilities/v1/abilities"
    list_url = f"{BASE_URL}{list_path}"
    try:
    ...
    save_response_screenshot("structure_abilitie", response)
