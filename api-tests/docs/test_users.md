# Test Cases — Users
    ...
    ## Source Information
    - **Controller:** WP_REST_Users_Controller
    - **Source File:** class-wp-rest-users-controller.php
...
- Response contains an array of items.
    ...
    **API:** GET /wp/v2/users?page=2&per_page=5
...
- If 200 → response body must be empty
    ...
    *Auto-generated from class-wp-rest-users-controller.php*
