# Test Cases — Plugin
    ...
    ## Source Information
    - **Controller:** WP_REST_Plugins_Controller
    - **Source File:** class-wp-rest-plugins-controller.php
    - **Endpoint:** `/wp/v2/plugins/{id}`
    - **Methods:** GET
    - **Type:** single
    ...
    **API:** GET /wp/v2/plugins/{id}/999999
    ...
    *Auto-generated from class-wp-rest-plugins-controller.php*
