# Test Cases — Settings
    ...
    ## Source Information
    - **Controller:** WP_REST_Settings_Controller
    - **Source File:** class-wp-rest-settings-controller.php
    - **Endpoint:** `/wp/v2/settings/{id}`
    - **Methods:** GET
    - **Type:** single
    ...
    **API:** GET /wp/v2/settings/{id}/999999
    ...
    *Auto-generated from class-wp-rest-settings-controller.php*
