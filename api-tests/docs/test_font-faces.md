# Test Cases — Font-Faces

    ## Source Information
    - **Controller:** WP_REST_Font_Faces_Controller
    - **Source File:** class-wp-rest-font-faces-controller.php
    - **Endpoint:** `/wp/v2/font-faces`
    - **Methods:** GET, HEAD
    - **Type:** collection
...
- Response contains an array of items.
    ...
    **API:** GET /wp/v2/font-faces?page=2&per_page=5
...
- If 200 → response body must be empty
    ...
    *Auto-generated from class-wp-rest-font-faces-controller.php*
