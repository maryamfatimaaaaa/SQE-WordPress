# Test Cases — Attachments
    ...
    ## Source Information
    - **Controller:** WP_REST_Attachments_Controller
    - **Source File:** class-wp-rest-attachments-controller.php
    - **Endpoint:** `/wp/v2/attachments`
    - **Methods:** GET, HEAD
    - **Type:** collection
...
- Response contains an array of items.
    ...
    **API:** GET /wp/v2/attachments?page=2&per_page=5
...
- If 200 → response body must be empty
    ...
    *Auto-generated from class-wp-rest-attachments-controller.php*
