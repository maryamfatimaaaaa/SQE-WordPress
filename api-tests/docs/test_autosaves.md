# Test Cases — Autosaves

    ## Source Information
    - **Controller:** WP_REST_Template_Autosaves_Controller
    - **Source File:** class-wp-rest-template-autosaves-controller.php
    - **Endpoint:** `/wp/v2/autosaves`
    - **Methods:** GET, HEAD
    - **Type:** collection
...
- Response contains an array of items.
    ...
    **API:** GET /wp/v2/autosaves?page=2&per_page=5
...
- If 200 → response body must be empty
    ...
    *Auto-generated from class-wp-rest-template-autosaves-controller.php*
