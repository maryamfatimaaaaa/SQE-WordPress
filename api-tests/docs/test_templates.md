# Test Cases — Templates
    ...
    ## Source Information
    - **Controller:** WP_REST_Templates_Controller
    - **Source File:** class-wp-rest-templates-controller.php
...
- Response contains an array of items.
    ...
    **API:** GET /wp/v2/templates?page=2&per_page=5
...
- If 200 → response body must be empty
    ...
    *Auto-generated from class-wp-rest-templates-controller.php*
