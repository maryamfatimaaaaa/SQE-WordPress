# Test Cases — Abilities
    ...
    **API:** GET /wp-abilities/v1/abilities
...
- Response contains an array of items.
    ...
    **API:** GET /wp-abilities/v1/abilities?page=2&per_page=5
...
- Headers include X-WP-Total & X-WP-TotalPages
    ...
    **API:** HEAD /wp-abilities/v1/abilities
