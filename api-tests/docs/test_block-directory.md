# Test Cases — Block-Directory

    ## Source Information
    - **Controller:** WP_REST_Block_Directory_Controller
    - **Source File:** class-wp-rest-block-directory-controller.php
    - **Endpoint:** `/wp/v2/block-directory/{id}`
    - **Methods:** GET
    - **Type:** single
    ...
    **API:** GET /wp/v2/block-directory/{id}/{id}
    ...
    **API:** GET /wp/v2/block-directory/{id}/999999
    ...
    *Auto-generated from class-wp-rest-block-directory-controller.php*
