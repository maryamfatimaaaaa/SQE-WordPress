# Test Cases — Widgets
    ...
    ## Source Information
    - **Controller:** WP_REST_Widgets_Controller
    - **Source File:** class-wp-rest-widgets-controller.php
...
- Response contains an array of items.
    ...
    **API:** GET /wp/v2/widgets?page=2&per_page=5
...
- If 200 → response body must be empty
    ...
    *Auto-generated from class-wp-rest-widgets-controller.php*
