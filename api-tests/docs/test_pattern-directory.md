# Test Cases — Pattern-Directory

    ## Source Information
    - **Controller:** WP_REST_Pattern_Directory_Controller
    - **Source File:** class-wp-rest-pattern-directory-controller.php
    - **Endpoint:** `/wp/v2/pattern-directory/{id}`
    - **Methods:** GET
    - **Type:** single
    ...
    **API:** GET /wp/v2/pattern-directory/{id}/{id}
    ...
    **API:** GET /wp/v2/pattern-directory/{id}/999999
    ...
    *Auto-generated from class-wp-rest-pattern-directory-controller.php*
