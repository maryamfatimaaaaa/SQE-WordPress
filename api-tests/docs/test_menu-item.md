# Test Cases — Menu-Item

    ## Source Information
    - **Controller:** WP_REST_Menu_Items_Controller
    - **Source File:** class-wp-rest-menu-items-controller.php
    - **Endpoint:** `/wp/v2/menu-items/{id}`
    - **Methods:** GET
    - **Type:** single
    ...
    **API:** GET /wp/v2/menu-items/{id}/{id}
    ...
    **API:** GET /wp/v2/menu-items/{id}/999999
    ...
    *Auto-generated from class-wp-rest-menu-items-controller.php*
