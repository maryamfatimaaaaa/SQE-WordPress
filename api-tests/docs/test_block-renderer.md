# Test Cases — Block-Renderer

    ## Source Information
    - **Controller:** WP_REST_Block_Renderer_Controller
    - **Source File:** class-wp-rest-block-renderer-controller.php
    - **Endpoint:** `/wp/v2/block-renderer/{id}`
    - **Methods:** GET
    - **Type:** single
    ...
    **API:** GET /wp/v2/block-renderer/{id}/{id}
    ...
    **API:** GET /wp/v2/block-renderer/{id}/999999
    ...
    *Auto-generated from class-wp-rest-block-renderer-controller.php*
