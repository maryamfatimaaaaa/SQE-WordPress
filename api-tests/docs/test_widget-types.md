# Test Cases — Widget-Types

    ## Source Information
    - **Controller:** WP_REST_Widget_Types_Controller
    - **Source File:** class-wp-rest-widget-types-controller.php
...
- Response contains an array of items.
    ...
    **API:** GET /wp/v2/widget-types?page=2&per_page=5
...
- If 200 → response body must be empty
    ...
    *Auto-generated from class-wp-rest-widget-types-controller.php*
