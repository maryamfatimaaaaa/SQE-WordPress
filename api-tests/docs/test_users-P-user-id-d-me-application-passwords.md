# Test Cases — Users/(?P<User Id>(?:[\D]+|Me))/Application-Passwords
    ...
    **API:** GET /wp/v2/users/(?P<user_id>(?:[/d]+|me))/application-passwords
...
- Response contains an array of items.
    ...
    **API:** GET /wp/v2/users/(?P<user_id>(?:[/d]+|me))/application-passwords?page=2&per_page=5
...
- Headers include X-WP-Total & X-WP-TotalPages
    ...
    **API:** HEAD /wp/v2/users/(?P<user_id>(?:[/d]+|me))/application-passwords
