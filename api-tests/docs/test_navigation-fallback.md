# Test Cases — Navigation-Fallback

    ## Source Information
    - **Controller:** WP_REST_Navigation_Fallback_Controller
    - **Source File:** class-wp-rest-navigation-fallback-controller.php
    - **Endpoint:** `/wp-block-editor/v1/navigation-fallback/{id}`
    - **Methods:** GET
    - **Type:** single
    ...
    **API:** GET /wp-block-editor/v1/navigation-fallback/{id}/{id}
    ...
    **API:** GET /wp-block-editor/v1/navigation-fallback/{id}/999999
    ...
    *Auto-generated from class-wp-rest-navigation-fallback-controller.php*
