# Test Cases — Url-Details

    ## Source Information
    - **Controller:** WP_REST_URL_Details_Controller
    - **Source File:** class-wp-rest-url-details-controller.php
    - **Endpoint:** `/wp-block-editor/v1/url-details/{id}`
    - **Methods:** GET
    - **Type:** single
    ...
    **API:** GET /wp-block-editor/v1/url-details/{id}/{id}
    ...
    **API:** GET /wp-block-editor/v1/url-details/{id}/999999
    ...
    *Auto-generated from class-wp-rest-url-details-controller.php*
