# Test Cases — Theme
    ...
    ## Source Information
    - **Controller:** WP_REST_Themes_Controller
    - **Source File:** class-wp-rest-themes-controller.php
    - **Endpoint:** `/wp/v2/themes/{id}`
    - **Methods:** GET
    - **Type:** single
    ...
    **API:** GET /wp/v2/themes/{id}/999999
    ...
    *Auto-generated from class-wp-rest-themes-controller.php*
