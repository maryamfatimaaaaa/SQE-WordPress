# Test Cases — Term
    ...
    - **Source File:** class-wp-rest-terms-controller.php
    - **Endpoint:** `/wp/v2/terms/{id}`
    - **Methods:** GET
    - **Type:** single
    ...
    *Auto-generated from class-wp-rest-terms-controller.php*
