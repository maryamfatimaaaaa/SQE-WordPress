# Test Cases — Block-Patterns/Patterns
    ...
    **API:** GET /wp/v2/block-patterns/patterns
...
- Response contains an array of items.
    ...
    **API:** GET /wp/v2/block-patterns/patterns?page=2&per_page=5
...
- Headers include X-WP-Total & X-WP-TotalPages
    ...
    **API:** HEAD /wp/v2/block-patterns/patterns
