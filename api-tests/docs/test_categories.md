# Test Cases — Categories
    ...
    ## Source Information
    - **Controller:** WP_REST_Abilities_V1_Categories_Controller
    - **Source File:** class-wp-rest-abilities-v1-categories-controller.php
    - **Endpoint:** `/wp-abilities/v1/categories`
    - **Methods:** GET, HEAD
    - **Type:** collection
    ...
    **API:** GET /wp-abilities/v1/categories
...
- Response contains an array of items.
    ...
    **API:** GET /wp-abilities/v1/categories?page=2&per_page=5
...
- Headers include X-WP-Total & X-WP-TotalPages
    ...
    **API:** HEAD /wp-abilities/v1/categories
...
- If 200 → response body must be empty
    ...
    *Auto-generated from class-wp-rest-abilities-v1-categories-controller.php*
