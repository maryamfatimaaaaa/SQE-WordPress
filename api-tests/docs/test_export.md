# Test Cases — Export
    ...
    ## Source Information
    - **Controller:** WP_REST_Edit_Site_Export_Controller
    - **Source File:** class-wp-rest-edit-site-export-controller.php
    - **Endpoint:** `/wp-block-editor/v1/export`
    - **Methods:** GET
    - **Type:** collection
    ...
    **API:** GET /wp-block-editor/v1/export
...
- Response contains an array of items.
    ...
    **API:** GET /wp-block-editor/v1/export?page=2&per_page=5
...
- Headers include X-WP-Total & X-WP-TotalPages
    ...
    **API:** HEAD /wp-block-editor/v1/export
...
- If 200 → response body must be empty
    ...
    *Auto-generated from class-wp-rest-edit-site-export-controller.php*
