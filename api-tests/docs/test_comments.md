# Test Cases — Comments
    ...
    - **Source File:** class-wp-rest-comments-controller.php
...
- Response contains an array of items.
    ...
    **API:** GET /wp/v2/comments?page=2&per_page=5
...
- If 200 → response body must be empty
    ...
    *Auto-generated from class-wp-rest-comments-controller.php*
