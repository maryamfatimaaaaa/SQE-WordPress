# Test Cases — Posts
    ...
    ## Source Information
    - **Controller:** WP_REST_Posts_Controller
    - **Source File:** class-wp-rest-posts-controller.php
...
- Response contains an array of items.
    ...
    **API:** GET /wp/v2/posts?page=2&per_page=5
...
- If 200 → response body must be empty
    ...
    *Auto-generated from class-wp-rest-posts-controller.php*
