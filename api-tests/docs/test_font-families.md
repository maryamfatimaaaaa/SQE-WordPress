# Test Cases — Font-Families

    ## Source Information
    - **Controller:** WP_REST_Font_Families_Controller
    - **Source File:** class-wp-rest-font-families-controller.php
    - **Endpoint:** `/wp/v2/font-families`
    - **Methods:** GET, HEAD
    - **Type:** collection
...
- Response contains an array of items.
    ...
    **API:** GET /wp/v2/font-families?page=2&per_page=5
...
- If 200 → response body must be empty
    ...
    *Auto-generated from class-wp-rest-font-families-controller.php*
